...
<td><span class=text><?php echo xlt('Middle Name'); ?>: </span></TD><td><input type=entry name=mname style="width:150px;" class='form-control' value="<?php echo attr($iter["mname"]); ?>"></td>
</TR>
...
<!-- Reorganized and edited from original-->
    <td>
...
<tr>
    ...
    <td>
        <input type="date" name="carDate" style="width:150px;" class="form-control" value="<?php echo attr($iter["carDate"]); ?>">
    </td>
    ...
    <td>
        <input type="date" name="icans" style="width:150px;" class="form-control" value="<?php echo attr($iter["icans"]); ?>">
    </td>
</tr>
...
<tr>
	...
	<td>
		<input type="text" name="taxonomy" style="width:150px;" class="form-control" value="<?php echo attr($iter["taxonomy"]); ?>">
	</td>
...
<tr>
	...
	<td class='text'><?php echo xlt('NewCrop eRX Role'); ?>:
	</td>
	<td>
	...
	<td>
		<span class="text"><?php echo xlt('Weno Provider ID'); ?>: </span></td><td><input type="text" name="erxprid" style="width:150px;" class="form-control" value="<?php echo attr($iter["weno_prov_id"]); ?>">
	</td>
</tr>
...
?>
	...
	<td>
		<span class=text><?php echo xlt('Additional Info'); ?>:</span>
	</td>
	<td>
		<textarea style="width:150px;" name="comments" wrap=auto rows=4 cols=25 class="form-control"><?php echo text($iter["info"]); ?></textarea>
	</td>
</tr>
