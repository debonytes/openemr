...
<tr>
<td style="width:150px;"><span class="text"><?php echo xlt('Username'); ?>: </span></td><td  style="width:220px;"><input type=entry name="rumple" style="width:150px;" class="form-control"><span class="mandatory"></span></td>
    <?php if (!$GLOBALS['use_active_directory']) { ?>
<td style="width:150px;"><span class="text"><?php echo xlt('Password'); ?>: </span></td><td style="width:250px;"><input type="password" style="width:150px;" name="stiltskin" class="form-control"><span class="mandatory"></span></td>
    <?php } else { ?>
...
<tr>
    ...
    <TD class='text' style="width:280px;"><input type='password' name=adminPass style="width:150px;"  value="" autocomplete='off' class="form-control"><font class="mandatory"></font></TD>
...
<tr>
<td><span class="text"><?php echo xlt('First Name'); ?>: </span></td><td><input type=entry name='fname' id='fname' style="width:150px;" class="form-control"><span class="mandatory"></span></td>
<td><span class="text"><?php echo xlt('Middle Name'); ?>: </span></td><td><input type=entry name='mname' style="width:150px;" class="form-control"></td>
</tr>
<tr>
<td><span class="text"><?php echo xlt('Last Name'); ?>: </span></td><td><input type=entry name='lname' id='lname' style="width:150px;" class="form-control"><span class="mandatory"></span></td>
<td><span class="text"><?php echo xlt('Default Facility'); ?>: </span></td><td><select style="width:150px;" name=facility_id class="form-control">
<?php
...
<tr>
<td><span class="text"><?php echo xlt('Federal Tax ID'); ?>: </span></td><td><input type=entry name='federaltaxid' style="width:150px;" class="form-control"></td>
<td><span class="text"><?php echo xlt('DEA number'); ?>: </span></td><td><input type=entry name='federaldrugid' style="width:150px;" class="form-control"></td>
</tr>
<tr>
<td><span class="text"><?php echo xlt('UPIN'); ?>: </span></td><td><input type="entry" name="upin" style="width:150px;" class="form-control"></td>
...
<tr>
	<td>
		<span class="text"><?php echo xlt('NPI'); ?>: </span></td><td><input type="entry" name="npi" style="width:150px;" class="form-control">
	</td>
...
<!-- Rearranged and edited -->
    ...
    <td>
        <?php echo generate_select_list("physician_type", "physician_type", '', '', xl('Select Type'), 'physician_type_class', '', '', array('style'=>'width:150px')); ?>
    </td>
</tr>

<tr>
	<td>
		<span class="text"><?php echo xlt('Car/Professional INS EXP Date'); ?>: </span>
	</td>
	<td><input type="date" name="carDate" style="width:150px;" class="form-control">
	</td>
	
	<td>
		<span class="text"><?php echo xlt('ICANS EXP Date'); ?>: </span>
	</td>
	<td>
		<input type="date" name="icans" style="width:150px;" class="form-control">
	</td>
</tr>
...
<tr>
	<td>
		<span class="text"><?php echo xlt('Billing Taxonomy'); ?>: </span>
	</td>
	<td>
		<input type="entry" name="taxonomy" style="width:150px;" class="form-control" value="207Q00000X"></td>
...
<tr>
	<td>
		<span class="text"><?php echo xlt('Provider Credentials/License#'); ?>: </span>
	</td>
	<td>
		<input type="text" name="state_license_number" style="width:150px;" class="form-control">
	</td>
	...
	<td>
		<input type="date" name="licenseDate" style="width:150px;" class="form-control">
	</td>
</tr>
...
<td>
    <?php echo generate_select_list("erxrole", "newcrop_erx_role", '', '', '--Select Role--', '', '', '', array('style'=>'width:150px')); ?>
</td>
...
<tr>
<td class='text'><?php echo xlt('Job Title'); ?>:</td>
 <td><select name="access_group[]" multiple style="width:150px;" class="form-control"> <!--width changed from 120 to fit group names-->
<?php
...
?>
  ...
  <td><textarea name=info style="width:150px;" cols=27 rows=4 wrap=auto class="form-control"></textarea></td>
</tr>
