...
<html>
    <head>
        <title><?php echo xlt("Comprehensive Diagnostic Assessment"); ?></title>
                            ...
                            <div class="col-md-12 margin-top-20" style="margin-top: 20px">
                                ...
                                <div style="margin-top: 20px;">
                                    ...
                                    <ul style="list-style-type: none; padding: 0; columns: 4;  -webkit-columns: 4;  -moz-columns: 4;">
                                        <?php 
                                            $medical_section_arr = array('Head injury/stroke', 'Loss of consciousness', 'Respiratory problems', 'Heart/Vascular problems', 'Liver disease', 'Thyroid problems', 'Cancer', 'Diabetes', 'Sleep problems', 'Weight change', 'Chronic pain', 'Enuresis/Encopresis', 'Allergies', 'Hypertension', 'Parasites/scabies/lice', 
                                                'STD', 'Seizures', 'Kidney disease', 'Appetite change');
                                            foreach($medical_section_arr as $medical):
                                         ?>
                                        <li>
                                            <div class="checkbox">
                                              <label>
                                        ...
                                        <div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab" style="padding: 10px"> 
                                            ...
                                            <div class="rows">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="form-group">
                                                        <?php 
                                                            $appearance_weight_arr = array('Underweight', 'Overweight', 'WNL', 'Other');
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="form-group">
                                                        <?php  
                                                            $appearance_hygiene_arr = array('Neat', 'Disheveled', 'Unkempt', 'Dirty', 'Other');
