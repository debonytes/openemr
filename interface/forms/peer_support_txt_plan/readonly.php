		...
		<div class="row">
            ...
            <div class="col-12">
              <div class="form-group mod-radiobtn">
                <div class="row">
                  <div class="col-sm-3">
                    <div class="radio">
                      <label>
                        <input type="radio" id="review1" name="review" value="90 Day Review" <?php echo ($check_res['review'] == '90 Day Review') ? "checked": ""; ?> disabled > 
                  ...
                  <div class="col-sm-3">
                    <div class="radio">
                      <label>
                        <input type="radio" id="review2" name="review" value="180 Day Review" <?php echo ($check_res['review'] == '180 Day Review') ? "checked": ""; ?> disabled > 
                  ...
                  <div class="col-sm-3">
                    <div class="radio">
                      <label>
                        <input type="radio" id="review3" name="review" value="270 Day Review" <?php echo ($check_res['review'] == '270 Day Review') ? "checked": ""; ?> disabled > 
                  ...
                  <div class="col-sm-3">
                    <div class="radio">
                      <label>
                        <input type="radio" id="review4" name="review" value="Other Review" <?php echo ($check_res['review'] == 'Other Review') ? "checked": ""; ?> disabled > 
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-5">
                    ...
                    <input type="text" class="form-control" id="participant_name" name="participant_name" value="<?php echo text($patient_full_name); ?>" disabled>
                    <small class="text-danger participant_name_error"></small>
                  </div>
                  <div class="col-sm-5">
                    <label for="medica_id"><?php echo xlt('Medicaid #:'); ?></label>
                    <input type="text" class="form-control" id="medica_id" name="medica_id" value="<?php echo text($check_res['medica_id']); ?>" disabled>
                    <small class="text-danger medica_id_error"></small>
                  </div>
                  <div class="col-sm-2">
                    <label for="diagnosis_codes"><?php echo xlt('Diagnosis Codes(s):'); ?></label>
                    <input type="text" class="form-control" id="diagnosis_codes" name="diagnosis_codes" value="<?php echo text($check_res['diagnosis_codes']); ?>" disabled>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="type_of_service" name="type_of_service" value="<?php echo text($check_res['type_of_service']); ?>" disabled>
                  </div>
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-2">
                    ...
                    <input type="text" class="form-control" id="date" name="date" value="<?php echo text($check_res['date']); ?>" disabled>
                    <small class="text-danger date_error"></small>
                  </div>
                  <div class="col-sm-2">
                    <label for="dob"><?php echo xlt('DOB:'); ?></label>
                    <input type="text" class="form-control" id="dob" name="dob" value="<?php echo text($patient_DOB); ?>" disabled>
              ...
              <div class="form-group">
                ...
                <textarea id="reasons_seeking_peer_support" class="form-control" rows="3" name="reasons_seeking_peer_support" disabled><?php echo text($check_res['reasons_seeking_peer_support']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="goal1_client_stmt" class="form-control" rows="3" name="goal1_client_stmt" disabled><?php echo text($check_res['goal1_client_stmt']); ?></textarea>
              </div>

              <div class="form-group">
                <label for="goal1"><?php echo xlt('Goal #1 (Must be in client’s own words):'); ?></label>
                <textarea id="goal1" class="form-control" rows="3" name="goal1" disabled><?php echo text($check_res['goal1']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="obj1_steps" class="form-control" rows="3" name="obj1_steps" disabled><?php echo text($check_res['obj1_steps']); ?></textarea>
              </div>
              <div class="form-group margin-top-20">
                ...
                <textarea id="obj1_intervention" class="form-control" rows="3" name="obj1_intervention" disabled><?php echo text($check_res['obj1_intervention']); ?></textarea>
              </div>
              <div class="row">
                <div class="col-sm-4">
                  <label for="obj1_freequency"><?php echo xlt('Frequency:'); ?></label>
                  <input type="text" class="form-control" id="obj1_freequency" name="obj1_freequency" value="<?php echo text($check_res['obj1_freequency']); ?>" disabled>
                </div>
                <div class="col-sm-4">
                  <label for="obj1_duration"><?php echo xlt('Duration:'); ?></label>
                  <input type="text" class="form-control" id="obj1_duration" name="obj1_duration" value="<?php echo text($check_res['obj1_duration']); ?>" disabled>
                </div>
                <div class="col-sm-4">
                  <label for="obj1_place"><?php echo xlt('Place'); ?>:</label>
                  <input type="text" class="form-control" id="obj1_place" name="obj1_place" value="<?php echo text($check_res['obj1_place']); ?>" disabled>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="obj1_2_steps" class="form-control" rows="3" name="obj1_2_steps" disabled><?php echo text($check_res['obj1_2_steps']); ?></textarea>
              </div>
              <div class="form-group">
                ...
                <textarea id="obj1_2_intervention" class="form-control" rows="3" name="obj1_2_intervention" disabled><?php echo text($check_res['obj1_2_intervention']); ?></textarea>
              </div>
              <div class="row">
                <div class="col-sm-4">
                  <label for="obj1_2_freequency"><?php echo xlt('Frequency:'); ?></label>
                  <input type="text" class="form-control" id="obj1_2_freequency" name="obj1_2_freequency" value="<?php echo text($check_res['obj1_2_freequency']); ?>" disabled>
                </div>
                <div class="col-sm-4">
                  <label for="obj1_2_duration"><?php echo xlt('Duration:'); ?></label>
                  <input type="text" class="form-control" id="obj1_2_duration" name="obj1_2_duration" value="<?php echo text($check_res['obj1_2_duration']); ?>" disabled>
                </div>
                <div class="col-sm-4">
                  <label for="obj1_2_place"><?php echo xlt('Place:'); ?></label>
                  <input type="text" class="form-control" id="obj1_2_place" name="obj1_2_place" value="<?php echo text($check_res['obj1_2_place']); ?>" disabled>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="goal2_client_stmt" class="form-control" rows="3" name="goal2_client_stmt" disabled><?php echo text($check_res['goal2_client_stmt']); ?></textarea>
              </div>
              <div class="form-group">
                <label for="goal2"><?php echo xlt('Goal #2 (Must be in client’s own words):'); ?></label>
                <textarea id="goal2" class="form-control" rows="3" name="goal2" disabled><?php echo text($check_res['goal2']); ?></textarea>
              </div>
              <div class="clearfix">&nbsp;</div>
              ...
              <div class="form-group">
                ...
                <textarea id="obj2_steps" class="form-control" rows="3" name="obj2_steps" disabled><?php echo text($check_res['obj2_steps']); ?></textarea>
              </div>
              <div class="form-group margin-top-20">
                ...
                <textarea id="obj2_intervention" class="form-control" rows="3" name="obj2_intervention" disabled><?php echo text($check_res['obj2_intervention']); ?></textarea>
              </div>
              <div class="row margin-top-20">
                <div class="col-sm-4">
                  <label for="obj2_freequency"><?php echo xlt('Frequency:'); ?></label>
                  <input type="text" class="form-control" id="obj2_freequency" name="obj2_freequency" value="<?php echo text($check_res['obj2_freequency']); ?>" disabled>
                </div>
                <div class="col-sm-4">
                  <label for="obj2_duration"><?php echo xlt('Duration:'); ?></label>
                  <input type="text" class="form-control" id="obj2_duration" name="obj2_duration" value="<?php echo text($check_res['obj2_duration']); ?>" disabled>
                </div>
                <div class="col-sm-4">
                  <label for="obj2_place"><?php echo xlt('Place:'); ?></label>
                  <input type="text" class="form-control" id="obj2_place" name="obj2_place" value="<?php echo text($check_res['obj2_place']); ?>" disabled>
                </div>
              </div>
              <div class="clearfix"></div>
    	        ...
    	        <div class="form-group">
    	          ...
    	          <textarea id="obj2_2_steps" class="form-control" rows="3" name="obj2_2_steps" disabled><?php echo text($check_res['obj2_2_steps']); ?> </textarea>
    	        </div>
    	        <div class="form-group margin-top-20">
    	          ...
    	          <textarea id="obj2_2_intervention" class="form-control" rows="3" name="obj2_2_intervention" disabled><?php echo text($check_res['obj2_2_intervention']); ?></textarea>
    	        </div>
    	        <div class="row margin-top-20">
    	          <div class="col-sm-4">
    	            <label for="obj2_2_freequency"><?php echo xlt('Frequency:'); ?></label>
    	            <input type="text" class="form-control" id="obj2_2_freequency" name="obj2_2_freequency" value="<?php echo text($check_res['obj2_2_freequency']); ?>" disabled>
    	          </div>
    	          <div class="col-sm-4">
    	            <label for="obj2_2_duration"><?php echo xlt('Duration:'); ?></label>
    	            <input type="text" class="form-control" id="obj2_2_duration" name="obj2_2_duration" value="<?php echo text($check_res['obj2_2_duration']); ?>" disabled>
    	          </div>
    	          <div class="col-sm-4">
    	            <label for="obj2_2_place"><?php echo xlt('Place:'); ?></label>
    	            <input type="text" class="form-control" id="obj2_2_place" name="obj2_2_place" value="<?php echo text($check_res['obj2_2_place']); ?>" disabled>
    	          </div>
    	        </div>
    	        <div class="clearfix"></div>
    	        ...
    	        <div class="form-group">
    	          ...
    	          <textarea id="obj2_3_steps" class="form-control" rows="3" name="obj2_3_steps" disabled><?php echo text($check_res['obj2_3_steps']); ?></textarea>
    	        </div>
    	        <div class="form-group margin-top-20">
    	          ...
    	          <textarea id="obj2_3_intervention" class="form-control" rows="3" name="obj2_3_intervention" disabled><?php echo text($check_res['obj2_3_intervention']); ?></textarea>
    	        </div>
    	        <div class="row margin-top-20">
    	          <div class="col-sm-4">
    	            <label for="obj2_3_freequency"><?php echo xlt('Frequency'); ?>:</label>
    	            <input type="text" class="form-control" id="obj2_3_freequency" name="obj2_3_freequency" value="<?php echo text($check_res['obj2_3_freequency']); ?>" disabled>
    	          </div>
    	          <div class="col-sm-4">
    	            <label for="obj2_3_duration"><?php echo xlt('Duration:'); ?></label>
    	            <input type="text" class="form-control" id="obj2_3_duration" name="obj2_3_duration" value="<?php echo text($check_res['obj2_3_duration']); ?>" disabled>
    	          </div>
    	          <div class="col-sm-4">
    	            <label for="obj2_3_place"><?php echo xlt('Place:'); ?></label>
    	            <input type="text" class="form-control" id="obj2_3_place" name="obj2_3_place" value="<?php echo text($check_res['obj2_3_place']); ?>" disabled>
    	          </div>
    	        </div>
              ...
              <div class="form-group">
                ...
                <textarea id="short_term_goal_client" class="form-control" rows="3" name="short_term_goal_client" disabled><?php echo text($check_res['short_term_goal_client']); ?></textarea>
              </div>
              <div class="form-group">
                <label for="short_term_goal"><?php echo xlt('Short-term Goal (Must be in client’s own words):'); ?></label>
                <textarea id="short_term_goal" class="form-control" rows="3" name="short_term_goal" disabled><?php echo text($check_res['short_term_goal']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="stg_obj_steps" class="form-control" rows="3" name="stg_obj_steps" disabled><?php echo text($check_res['stg_obj_steps']); ?></textarea>
              </div>
              <div class="form-group">
                ...
                <textarea id="stg_obj_intervention" class="form-control" rows="3" name="stg_obj_intervention" disabled><?php echo text($check_res['stg_obj_intervention']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="stg_obj_frequency" name="stg_obj_frequency" value="<?php echo text($check_res['stg_obj_frequency']); ?>" disabled>
                  </div>
                  <div class="col-sm-4">
                    <label for="stg_obj_duration"><?php echo xlt('Duration'); ?>:</label>
                    <input type="text" class="form-control" id="stg_obj_duration" name="stg_obj_duration" value="<?php echo text($check_res['stg_obj_duration']); ?>" disabled>
                  </div>
                  <div class="col-sm-4">
                    <label for="stg_obj_place"><?php echo xlt('Place'); ?>:</label>
                    <input type="text" class="form-control" id="stg_obj_place" name="stg_obj_place" value="<?php echo text($check_res['stg_obj_place']); ?>" disabled >
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="mod-checkbox">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities1" name="modalities[]" value="Individual Therapy" <?php echo (in_array('Individual Therapy', $modalities)) ? 'checked' : '' ?> disabled> 
                      <?php echo xlt('Individual Therapy'); ?> 
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities2" name="modalities[]" value="Family Therapy" <?php echo (in_array('Family Therapy', $modalities)) ? 'checked' : '' ?> disabled> 
                      <?php echo xlt('Family Therapy'); ?>
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities3" name="modalities[]" value="Family w/o client" <?php echo (in_array('Family w/o client', $modalities)) ? 'checked' : '' ?> disabled> 
                      <?php echo xlt('Family w/o client'); ?>
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities4" name="modalities[]" value="Group" <?php echo (in_array('Group', $modalities)) ? 'checked' : '' ?> disabled> 
                      <?php echo xlt('Group'); ?>
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities5" name="modalities[]" value="CBRS Skills Training" <?php echo (in_array('CBRS Skills Training', $modalities)) ? 'checked' : '' ?> disabled > 
                      <?php echo xlt('CBRS Skills Training'); ?> 
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities6" name="modalities[]" value="Peer Support Services" <?php echo (in_array('Peer Support Services', $modalities)) ? 'checked' : '' ?> disabled> 
                      <?php echo xlt('Peer Support Services'); ?> 
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities7" name="modalities[]" value="Service Coordination" <?php echo (in_array('Service Coordination', $modalities)) ? 'checked' : '' ?> disabled >
                      <?php echo xlt('Service Coordination'); ?>
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="modalities10" name="modalities[]" value="Medication Management" <?php echo (in_array('Medication Management', $modalities)) ? 'checked' : '' ?> disabled>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control" id="target_date" name="target_date" value="<?php echo (!empty($check_res['target_date']) && ($check_res['target_date'] != '0000-00-00')) ? text(date('Y-m-d', strtotime($check_res['target_date']))) : ''; ?>" disabled>
                </div>
                <div class="col-sm-6">
                  ...
                  <div class="mod-checkbox">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" id="responsible" name="responsible[]" value="Client" <?php echo (in_array('Client', $responsible)) ? 'checked' : '' ?> disabled>
                        <?php echo xlt('Client'); ?>
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" id="responsible2" name="responsible[]" value="Peer Support Provider" <?php echo (in_array('Peer Support Provider', $responsible)) ? 'checked' : '' ?> disabled>
              ...
              <div class="form-group">
                ...
                <textarea id="individuals_included_plan_rev" class="form-control" rows="3" name="individuals_included_plan_rev" disabled><?php echo text($check_res['individuals_included_plan_rev']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea id="svcs_coordinated" class="form-control" rows="3" name="svcs_coordinated" disabled><?php echo text($check_res['svcs_coordinated']); ?></textarea>
              </div>

              <div class="form-group">
                <label for="linkgs_peer_support"><?php echo xlt('Linkages with peer support services and other community resources:'); ?></label>
                <textarea id="linkgs_peer_support" class="form-control" rows="3" name="linkgs_peer_support" disabled><?php echo text($check_res['linkgs_peer_support']); ?></textarea>
              </div>

              <h5><?php echo xlt('FOR REVIEWS ONLY'); ?></h5>
              <div class="form-group">
                <label for="for_rev_progress"><?php echo xlt('Progress toward the Objectives'); ?>:</label>
                <textarea id="for_rev_progress" class="form-control" rows="3" name="for_rev_progress" disabled><?php echo text($check_res['for_rev_progress']); ?></textarea>
              </div>
              <div class="form-group">
                <label for="for_rev_changes"><?php echo xlt('Changes, amendments or deletions to Objectives:'); ?></label>
                <textarea id="for_rev_changes" class="form-control" rows="3" name="for_rev_changes" disabled><?php echo text($check_res['for_rev_changes']); ?></textarea>
              </div>
              <div class="form-group">
                <label for="for_rev_obj"><?php echo xlt('New Objective:'); ?></label>
                <textarea id="for_rev_obj" class="form-control" rows="3" name="for_rev_obj" disabled><?php echo text($check_res['for_rev_obj']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" id="for_rev_modality" name="for_rev_modality" value="<?php echo text($check_res['for_rev_modality']); ?>" disabled>
                  </div>
                  <div class="col-sm-3">
                    <label for="for_rev_frequency"><?php echo xlt('Frequency:'); ?></label>
                    <input type="text" class="form-control" id="for_rev_frequency" name="for_rev_frequency" value="<?php echo text($check_res['for_rev_frequency']); ?>" disabled>
                  </div>
                  <div class="col-sm-3">
                    <label for="for_rev_duraction"><?php echo xlt('Duration:'); ?></label>
                    <input type="text" class="form-control" id="for_rev_duraction" name="for_rev_duraction" value="<?php echo text($check_res['for_rev_duraction']); ?>" disabled>
                  </div>
                  <div class="col-sm-3">
                    <label for="for_rev_place"><?php echo xlt('Place:'); ?></label>
                    <input type="text" class="form-control" id="for_rev_place" name="for_rev_place" value="<?php echo text($check_res['for_rev_place']); ?>" disabled >
                  </div>
                </div>
              </div>
