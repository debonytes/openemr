                   ...
                   <fieldset style="padding-top: 20px!important;">
                            ...
                            <div class="col-md-12 margin-top-10">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                          <input type="text" class="form-control" id="date" name="date" value="<?php echo text(date('Y-m-d', strtotime($check_res['date']))); ?>" disabled>
                            ...
                            <div class="col-md-12 margin-top-20">
                                ...
                                <div class="form-group margin-top-10">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control datepicker" id="last_scan_date" name="last_scan_date" autocomplete="off" value="<?php echo text($check_res['last_scan_date']); ?>" disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="margin-top-20">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="problem_1_date_review" class="form-control datepicker" autocomplete="off" value="<?php echo text($check_res['problem_1_date_review']); ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
