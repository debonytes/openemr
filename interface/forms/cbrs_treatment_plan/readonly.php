                   ...
                   <fieldset style="padding-top: 20px!important;" class="form_content">
                            ...
                            <div class="col-md-12 margin-top-30">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" class="form-control " id="date" name="date" value="<?php echo ($check_res['date']) ? text(date('m/d/Y', strtotime($check_res['date']))) : date('m/d/Y'); ?>" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                          <input type="text" class="form-control datepicker" id="date_birth" name="date_birth" autocomplete="off" value="<?php echo text($patient_DOB); ?>" disabled>
                            ...
                            <div class="col-md-12 margin-top-20">
                                ...
                                <div class="form-group margin-top-10">
                                    ...
                                    <div class="col-sm-3">
                                      <input type="text" class="form-control" id="last_scan_date" name="last_scan_date" autocomplete="off" value="<?php echo text($check_res['last_scan_date']); ?>" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="padding-20 row_other">
                            ...
                            <div class="col-md-12 margin-top-60"> <!-- beginning of Problem 2 -->
                            ...
                            <div class="col-md-12 margin-top-80"> <!-- beginning of Problem 3 -->
            ...
            $(document).ready(function(){
                ...
                $("#print").on('click', function(){
                    $('.form_content').printThis({
                        ...
                        pageTitle: "CBRS Treatment Plan",              // add title to print page
                        removeInline: false,        // remove inline styles from print elements
                        removeInlineSelector: "*",  // custom selectors to filter inline styles. removeInline must be true
                        printDelay: 333,            // variable print delay
                        header: "<h2>CBRS Treatment Plan</h2>",               // prefix to html
