                    ...
                    <fieldset style="padding-top: 20px!important;" class="form_content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="location" id="location" class="form-control " value="<?php echo ($check_res['location']) ? text($check_res['location']) : ''; ?>" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="session_number" id="session_number" class="form-control" value="<?php echo ($check_res['session_number']) ? text($check_res['session_number']) : ''; ?>" autocomplete="off">
                            ...
                            <div class="col-md-12 margin-top-20">
                                ...
                                <textarea name="service_note" id="service_note" rows="4" class="form-control"><?php echo ($check_res['service_note']) ? text($check_res['service_note']) : ''; ?></textarea>
