                                    ...
                                    <div class="col-sm-6">
                                        <?php  
                                            if($check_res['goals_object_1']){
                                                ...
                                                $goals_1 = text($last_record['goals_object_1']);
                                            } else {
                                                $goals_1 = '';
                                            }
                                        ?>
                                        <input type="text" class="form-control " name="goals_object_1" id="goals_object_1" style="width: 250px; float: left; margin-right: 20px" value="<?php echo $goals_1; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <?php  
                                            if($check_res['goals_object_2']){
                                                ...
                                                $goals_2 = text($last_record['goals_object_2']);
                                            } else {
                                                $goals_2 = '';
                                            }
                                        ?>
                                        <input type="text" class="form-control" name="goals_object_2" id="goals_object_2" style="width: 250px; float: left; margin-right: 20px" value="<?php echo $goals_2; ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <?php  
                                            if($check_res['goals_object_3']){
                                                ...
                                                $goals_3 = text($last_record['goals_object_3']);
                                            } else {
                                                $goals_3 = '';
                                            }
                                        ?>
                                        <input type="text" class="form-control" name="goals_object_3" id="goals_object_3" style="width: 250px; float: left; margin-right: 20px" value="<?php echo $goals_3; ?>">
                            ...
                            <div class="col-md-12 margin-top-30">
                                <?php 
                                    if($check_res['narrative_services']){
                                        ...
                                        $narrative = text($last_record['narrative_services']); 
                                    } else {
                                        $narrative = '';
                                    }
                                ?>
                                <label for="narrative_services"><?php echo xlt('Narrative of Service:'); ?></label>
                                <textarea name="narrative_services" id="narrative_services" rows="4" class="form-control"><?php echo $narrative; ?></textarea>
                            ...
                            <div class="col-md-12 margin-top-20">
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php
                                                if($check_res['meet_again_date']){
                                                    ...
                                                    $meet_again = text($last_record['meet_again_date']);
                                                } else {
                                                    $meet_again = '';
                                                }
                                            ?>
                                            <input type="text" class="form-control datepicker" name="meet_again_date" id="meet_again_date" value="<?php echo $meet_again; ?>" autocomplete="off">
                                    ...
                                    <div class="col-sm-3 date-time-align">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control timepicker" name="meet_again_time" id="meet_again_time" value="<?php echo ($check_res['meet_again_time']) ? text($check_res['meet_again_time']) : ($last_record['meet_again_time']) ? text($last_record['meet_again_time']) : ''; ?>" autocomplete="off">
