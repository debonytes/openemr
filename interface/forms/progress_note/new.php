        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h2><?php echo xlt('Progress Note'); ?></h2>
                </div>
            </div>
            <?php
            ...
            <div class="row">
                ...
                <form method="post" id="my_progress_notes_form" name="my_progress_notes_form" action="<?php echo $rootdir; ?>/forms/progress_note/save.php?id=<?php echo attr_url($formid); ?>">          
                    ...
                    <fieldset>
                        <legend class=""><?php echo xlt('Progress Note'); ?></legend>
