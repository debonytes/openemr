...
<html>
    <head>
        <title><?php echo xlt("Targeted Care Coordination Note"); ?></title>
        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h2><?php echo xlt('Targeted Care Coordination Note'); ?></h2>
                </div>
            </div>
            <?php
            ...
            <div class="row">
                ...
                <form method="post" id="my_progress_notes_form" name="my_progress_notes_form" action="#">
                    ...
                    <fieldset class="form_content">
                        <legend class=""><?php echo xlt('Targeted Care Coordination Note'); ?></legend>
                            <!--
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="tcc" id="tcc" class="form-control" value="<?php echo text($check_res['tcc']); ?>" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" value="T1017 U3 HN - TCC" readonly disabled>
                                        <input type="hidden" name="billing_code" value="T1017 U3 HN - TCC">
                                    </div>                                    
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12 margin-top-20" >
                                ...
                                <div class="form-group margin-top-20">
                                    <label for="" class="col-sm-2 control-label"><strong><?php echo xlt('Objective 1.1 (T1017):'); ?></strong></label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group margin-top-20">
                                    <label for="" class="col-sm-2 control-label"><strong><?php echo xlt('Objective 2.1 (T1017):'); ?></strong></label>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group margin-top-20">
                                    <label for="" class="col-sm-2 control-label"><strong><?php echo xlt('Objective 3.1 (T1017):'); ?></strong></label>
                                    <div class="col-sm-6">
