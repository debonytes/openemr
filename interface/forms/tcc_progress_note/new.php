    ...
    <body class="body_top">
        <div class="container">
            ...
            <div class="row">
                ...
                <form method="post" id="my_progress_notes_form" name="my_progress_notes_form" action="<?php echo $rootdir; ?>/forms/tcc_progress_note/save.php?id=<?php echo attr_url($formid); ?>">
                    ...
                    <fieldset>
                        <legend class=""><?php echo xlt('Targeted Care Coordination Note'); ?></legend>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="cbrs" class="col-sm-3 "><?php echo xlt('Targeted Care Coordinator'); ?></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"  class="form-control" value="T1017 U3 HN - TCC" readonly>
