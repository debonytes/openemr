...
CREATE TABLE IF NOT EXISTS `form_comprehensive_assessment` (
  ...
  `name_physician` varchar(255) DEFAULT NULL,
  `obtain_medical_provider` varchar(100) DEFAULT NULL,
  `name_current_psychiatrist` varchar(255) DEFAULT NULL,
  `name_past_psychiatrist` varchar(255) DEFAULT NULL,
  ...
  `child_depression_details` varchar(255) DEFAULT NULL,
  ...
  `vegetative_appetite` varchar(255) DEFAULT NULL,
  `vegetative_sleep` varchar(255) DEFAULT NULL,
  `vegetative_concentration` varchar(255) DEFAULT NULL,
  ...
  `name_examiner` varchar(255) DEFAULT NULL,
  `date_examine` varchar(255) DEFAULT NULL, 
