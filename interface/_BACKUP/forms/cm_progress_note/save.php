<?php
/*
 * This program saves data from the cm_progress_note
 *
 * @package   OpenEMR
...
/* NOTES
Table Name: form_cm_progress_note
Fields: 
==============================================
...
if (empty($id)) {
    $newid = sqlInsert(
        "INSERT INTO form_cm_progress_note SET $sets",
        [
            $pid,
    ...
    addForm($encounter, "Case Management Progress Note", $newid, "cm_progress_note", $pid, $userauthorized);
} else {
    sqlStatement(
        "UPDATE form_cm_progress_note SET $sets WHERE id = ?",
        [
            $pid,
            $_SESSION["authProvider"],
            $_SESSION["authUser"],
