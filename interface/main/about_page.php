        ...
        <div class="row">
            <div class="col-xs-12 col-md-4 col-md-offset-4 text-center">
                <div class="page-header">
                    <h1><?php echo xlt("About");?>&nbsp;MHER</h1>
					<h2><?php echo xlt("Mental Health Electronic Record System");?></h2>
                </div>
				<h4><?php echo xlt("MHER Version Number: v1.0"); ?></h4>
                <!--<h4><?php  echo xlt('OpenEMR Version Number'); ?>: <?php echo "v".text($openemr_version) ?></h4>-->
                <span class="text product-registration"><span class="email"></span> <span class="id"></span></span><br>
                <h5><?php if (!empty($GLOBALS['support_phone_number'])) { ?>
				...
				<!-- commented out, the donations and review sections are not needed -->
...
<!--<img src="/xampp/htdocs/openemr/sites/default/images/Tech Help.jpg" alt="Tech Image" width="200"
         height="80" class="img-center">-->
