...
$GLOBALS_METADATA = array(
    ...
    'Security' => array(
        ...
        'user_credential_expiration_lockout' => array(
            xl('User Lockout on Credential Expiration'),
            'bool',                           // data type
            '0',                              // default
            xl('Lockout the user should any required credentials (ICANS, License, etc.) expire.')
        ),

        'credential_expiration_alert' => array(
            xl('Credential Expiration Alert Period'),
            'num',                            // data type
            '7',                              // default
            xl('Period in days where the user is alerted to any future credential expiration. -1 means there will be no alert if User Credential Lockout is disabled')
        ),
